...
void gravity_collisions(entity_Obj * entity, vector<seed_Obj> * models)
{
...
void collisions(entity_Obj * entity, vector<seed_Obj> * models)
{
    (*entity).colliding = false;
    for (auto it = (*models).begin(); it < (*models).end(); it++)
    {
...
{
    entity_collisions(ptr_player, ptr_enemyONE);
    collisions(ptr_player, ptr_level_objects);
    collisions_generated(ptr_player, ptr_generated_buildings);
    gravity_collisions(ptr_player, ptr_level_objects);
}

void enemies_collisions()
{
    entity_collisions(ptr_enemyONE, ptr_player);
    collisions(ptr_enemyONE, ptr_level_objects);
    collisions_generated(ptr_enemyONE, ptr_generated_buildings);
    gravity_collisions(ptr_enemyONE, ptr_level_objects);
}
